...
\section*{Ejercicio \#2}
A partir de los objetos abstractos creados en el ejercicio \#1 de la hoja de trabajo \#1,
crear en el proyecto ``QueHaceres'' dos archivos separados llamados ``QueHacer.cs''
y ``QueHaceres.cs''. Cada archivo debe tener una clase que implemente su respectivo
objeto abstracto. Colocar ambas clases dentro del \emph{namespace} ``QueHaceres''.
